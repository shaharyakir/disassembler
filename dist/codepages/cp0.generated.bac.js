...
//     let args = slice.readUintNumber(24);
//     return '(FIXED)';
// });
...
//     let args = slice.readUintNumber(13);
//     return '(EXT)';
// });
// // 8583168 (DUMMY)
...
//     return '(FIXED)';
// });
// // CP0Auto.insertHex('83ff', 16, 'PUSHNAN');
...
//     let args = slice.readUintNumber(15);
//     return '(EXT)';
// });
// CP0Auto.insertHex('8d', 8, (slice) => {
//     let args = slice.readUintNumber(18);
//     return '(EXT)';
// });
// // 9281536 (DUMMY)
...
//     return '(EXT)';
// });
// CP0Auto.insertHex('a0', 8, 'ADD');
// CP0Auto.insertHex('a1', 8, 'SUB');
// CP0Auto.insertHex('a2', 8, 'SUBR');
// CP0Auto.insertHex('a3', 8, 'NEGATE');
// CP0Auto.insertHex('a4', 8, 'INC');
// CP0Auto.insertHex('a5', 8, 'DEC');
...
//     return '(FIXED)';
// });
// CP0Auto.insertHex('a8', 8, 'MUL');
// CP0Auto.insertHex('a90', 12, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
// // 11079680 (DUMMY)
// CP0Auto.insertHex('a92', 12, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
// CP0Auto.insertHex('a93', 12, (slice) => {
//     let args = slice.readUintNumber(24);
//     return '(FIXED)';
// });
// // 11091968 (DUMMY)
// CP0Auto.insertHex('a98', 12, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
// // 11112448 (DUMMY)
...
//     let args = slice.readUintNumber(21);
//     return '(EXT)';
// });
...
// CP0Auto.insertHex('de0000', 8, 'IF');
// CP0Auto.insertHex('df0000', 8, 'IFNOT');
...
// CP0Auto.insertHex('f47400', 16 /* was 12 */, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
// // 16023552 (DUMMY)
...
//     return '(FIXED)';
// });
// CP0Auto.insertHex('f4a400', 16 /* was 13 */, (slice) => {
//     let args = slice.readUintNumber(24);
//     return '(EXT)';
// });
...
// CP0Auto.insertHex('f4ac00', 16 /** was 13 */, (slice) => {
//     let args = slice.readUintNumber(24);
//     return '(EXT)';
// });
// // 16035840 (DUMMY)
...
// CP0Auto.insertHex('f82a00', 16 /** was 12 */, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
...
// CP0Auto.insertHex('f84100', 16 /** was 11 */, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
// CP0Auto.insertHex('f86000', 16, 'SETGLOBVAR');
// CP0Auto.insertHex('f86100', 16 /** was 11 */, (slice) => {
//     let args = slice.readUintNumber(16);
//     return '(FIXED)';
// });
// // 16285696 (DUMMY)
...
// // });
// export { CP0Auto }
//# sourceMappingURL=cp0.generated.bac.js.map